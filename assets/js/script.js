...
const languageDictionaries = {
  fr: {
    ...
    "Available from Tetouan, Morocco for departures across Asia.": "Disponibles depuis Tetouan, Maroc, pour des departs a travers l'Asie.",
  ...
  ar: {
    ...
    "Call Us": "اتصل بنا",
    "Email Us": "راسلنا",
    "Available from Tetouan, Morocco for departures across Asia.": "متاحون من تطوان، المغرب، لرحلات عبر اسيا.",
    "Contact Us": "اتصل بنا",
